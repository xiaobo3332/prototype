...
class NP(i3.PCell):
    ...
    class Layout(i3.LayoutView):
        ...
        def _generate_elements(self, elems):
            ...
            elems += i3.Rectangle(layer=self.layer, center=(x0 + 6500+2000, y0 + 1000 + (3000 - self.width) / 4),
                                  box_size=(self.length, (3000 - self.width) / 2))

            elems += i3.Rectangle(layer=self.layer,
                                  center=(x0 + 6500+2000, y0 + 1000 + self.width + (3000 - self.width) * 3 / 4),
                                  box_size=(self.length, (3000 - self.width) / 2))
            ...
            if self.pillar:
                ...
                for i in range(7):
                    elems += i3.Rectangle(layer=self.layer,
                                          center=(10000 - 725 - i * 750+2000, 1000 + (3000 - self.width) / 2 + 30),#change
                                          box_size=(50, 60))
                    elems += i3.Rectangle(layer=self.layer, center=(
                        10000 - 725 - i * 750+2000, 1000 + (3000 - self.width) / 2 + self.width - 30),#change
                                          box_size=(50, 60))
            if self.width > 330:
                self.label += "W"
            if self.pocket:
