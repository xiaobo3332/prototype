...
class my_dc(PlaceAndAutoRoute):
    ...
    class Layout(PlaceAndAutoRoute.Layout):
        ...
        def _default_child_transformations(self):
            ...
            trans['ring0'] = (1300, 0)
            trans['ring1'] = (1300, 0 + column)
            trans['ring2'] = (1300, 0 + 2 * column)
            ...
            trans["taper6"] = i3.HMirror(0) + i3.Translation((3000, 2500 + column))
            trans["taper7"] = i3.HMirror(0) + i3.Translation((3000, -2500 + column))

            trans["taper8"] = (0, 4000 + 2 * column)
            trans["taper9"] = (0, -4000 + 2 * column)
            trans["taper10"] = i3.HMirror(0) + i3.Translation((3000, 2500 + 2 * column))
            trans["taper11"] = i3.HMirror(0) + i3.Translation((3000, -2500 + 2 * column))
...
dc_10 = my_dc(gap_inc_vec=[420.0, 430.0], gap_inc_vec2=[110], name="ring1")
dc_10_layout = dc_10.Layout()
# dc_10_layout.visualize(annotate=True)
# dc_10_layout.write_gdsii("MMI22.gds")


dc_15 = my_dc(gap_inc_vec=[450, 460, 470], name="ring2")
