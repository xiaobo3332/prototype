...
class my_exe2(PlaceComponents):
    ...
    def _default_DC_list(self):
        ...
        recess0 = NP_mmi12(width=338, pocket=True, tilt=True)
        ...
        recess8 = NP_mmi12(width=338, pillar=True, pocket=False, tilt=False)
        recess9 = NP_mmi12(width=338, pillar=True, pocket=True, tilt=False)
    ...
    class Layout(PlaceComponents.Layout):
        ...
        def _default_child_transformations(self):
            ...
            row = 3000
            trans["CHILD0"] = (0, 0)
            trans["CHILD1"] = i3.HMirror(1250) - i3.Translation((2500, 0))
