...
class NP_mmi12(i3.PCell):
    ...
    # Mesa parameters
    length = i3.PositiveNumberProperty(default=3000.0)
    ...
    class Layout(i3.LayoutView):
        ...
        def _generate_elements(self, elems):
            ...
            elems += i3.Rectangle(layer=self.layer, center=(x0 + 6500+2000+2000, y0 + 600 + (1800 - self.width) / 4),
                                  box_size=(self.length, (1800 - self.width) / 2))

            elems += i3.Rectangle(layer=self.layer,
                                  center=(x0 + 6500+2000+2000, y0 + 600 + self.width + (1800 - self.width) * 3 / 4),
                                  box_size=(self.length, (1800 - self.width) / 2))
