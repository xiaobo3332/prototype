    ...
    class Layout(i3.LayoutView):
        ...
        def _generate_elements(self, elems):
            ...
            if self.horizontal == False:
                ...
                # ADD RECESS
                elems += i3.SRef(reference=AlignmentMarker(layer=i3.TECH.PPLAYER.WG.TEXT, layer_text="1_TiW"),
                                 transformation=i3.Translation((x0 + 0.0 * self.h_spacing, y0)))
                elems += i3.SRef(reference=AlignmentMarker(layer=i3.TECH.PPLAYER.HFW, complement=True),
                                 transformation=i3.Translation((x0 + 0.0 * self.h_spacing, y0)))

                # ADD AL
                elems += i3.SRef(reference=AlignmentMarker(layer=i3.TECH.PPLAYER.WG.TEXT, layer_text="2_NiAu"),
                ...
                # RECESS adjustment according to the mask  TiW adjustment
                ...
                generated1 = i3.TECH.PPLAYER.NONE.DOC - i3.TECH.PPLAYER.CONTACT.PILLAR
                mapping = {generated1: i3.TECH.PPLAYER.FC.HOLE}  # directly map to heater NiAu plating layer3/12
    ...
    def _default_DC_list(self):
        ...
        for i in range(0, 2, 1):
            for j in range(0, 3, 1):
                cell = AlignmentMarkerSet(position=(-2000 + i * 20000+263.5, 468.5 + j * 10000-640-200))
